#!/usr/bin/env python3
# Vendored/adapted from deusyu/translate-book (MIT, Copyright (c) 2025 Rainman). See LICENSE.
"""
...
def main():
    ...
    parser.add_argument("temp_dir", help="Path to the run work/ directory (contains chunkNNNN.md files)")
